...
// import pics from "../Assets/484A2529.jpg";
export default function Home() {
  return (
    <div className="bg-[#1c1e21] text-white ">
      <header className="flex justify-between px-4 pt-14 shadow-lg sticky">
        <span className=" ">
          <main className="flex cursor-pointer">
            ...
            <input
              ...
              className="bg-[#1c1e21] border-blue-950 border-2 rounded-full text-white px-4 py-2 ml-4"
            />
          </main>
        </span>
      ...
      <section className="w-full flex justify-between px-4 cursor-pointer">
        <aside className="w-1/3 sticky">
          ...
          <p className="flex pt-4 gap-3 text-[#8d949e]">
            <GiFireplace className="text-2xl" />
            Market Place
          </p>
          <p className="flex pt-4 gap-3 text-[#8d949e]">
          ...
          <p className="flex pt-4 gap-3 text-[#8d949e]">
            <BsFillSave2Fill className="text-2xl" />
            Saved
          </p>
          <p className="flex pt-4 gap-3 text-[#8d949e]">
        ...
        <main className="w-1/3 pt-10">
          <div className="border-[#1c1e21] rounded-lg w-full px-4">
            ...
            <hr className="mt-2 text-[#1c1e21]" />

           
          </div>
        </main>

        <aside className="w-1/3 sticky pl-[20%] ">
          <p className="flex pt-4 gap-3 text-[#8d949e]">
            <CgProfile className="text-2xl" />
            Emmanuel Nwamini
          </p>
          ...
          <p className="flex pt-4 gap-3 pb-2 text-[#8d949e]">
            <CgProfile className="text-2xl" />
            Emmanuel Nwamini
          </p>
